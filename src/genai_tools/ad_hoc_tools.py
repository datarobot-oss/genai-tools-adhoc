...
TOOL_TO_INTEGRATION: dict[str, str] = {
    ...
    "milvus_create_database": "milvus",
    "milvus_ensure_index_and_load": "milvus",
    "milvus_insert_data": "milvus",
    "milvus_inspect_collections": "milvus",
    "milvus_list_databases": "milvus",
    "milvus_query": "milvus",
    ...
    "wl_list_workloads": "workload",
    "wl_create_workload_payload": "workload",
    "wl_create_deployment_payload": "workload",
    "wl_create_workload": "workload",
    "wl_get_workload": "workload",
    "wl_start_workload": "workload",
    "wl_stop_workload": "workload",
    "wl_wait_for_workload_status": "workload",
    "wl_delete_workload": "workload",
    "wl_list_deployments": "workload",
    "wl_get_deployment": "workload",
    "wl_get_deployment_stats": "workload",
    "wl_create_deployment": "workload",
    "wl_wait_for_deployment_status": "workload",
    "wl_delete_deployment": "workload",
    "wl_list_artifacts": "workload",
    "wl_get_artifact": "workload",
    "wl_list_bundles": "workload",
    "dr_get_deployment_features": "predictive",
    "dr_get_deployment_prediction_info": "predictive",
    "dr_predict": "predictive",
    "dr_train_regression": "predictive",
    "dr_train_classification": "predictive",
    "dr_train_time_series": "predictive",
    "dr_train_anomaly_detection": "predictive",
    "dr_train_clustering": "predictive",
    "dr_add_deployment_tool_tag": "predictive",
    "dr_register_deployment_with_mcp": "predictive",
}
